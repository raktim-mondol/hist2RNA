...
main_gene_file = pd.read_csv('./gene_expression_file/main_gene_expression.csv')
...
pam50_gene = pd.read_csv('./gene_expression_file/pam50_gene_list.txt', index_col = 'pam_50_gene')
selected_gene = pd.DataFrame(main_gene_file[pam50_gene.index])


selected_gene.to_csv('./gene_expression_file/pam50_gene_expression.csv', index=True)
