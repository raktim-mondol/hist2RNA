...
for image_file in next(os.walk(path))[2]:
    ...
    if (image_file.split('.')[2] == file_types):
        ...
        #img=cv2.imread('tcga_image/009.png', 1)
        img = cv2.cvtColor(image_, cv2.COLOR_BGR2RGB)
        ...
        plt.imsave("./saved_images/" + image_file, Inorm)
        #plt.imsave("saved_images/HnE_separated_H.jpg", H)
        #plt.imsave("saved_images/HnE_separated_E.jpg", E)
